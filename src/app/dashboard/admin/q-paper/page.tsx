  ...
  return (
    <div className="space-y-6 print:hidden">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-slate-900 mb-1">Question Paper Developer</h2>
          <p className="text-slate-500">Create standard university question papers with AI-assisted question picking and PDF export.</p>
        </div>
        <div className="flex gap-3">
          <button onClick={() => onNavigate('setup')} className="bg-slate-100 text-slate-700 font-bold h-12 px-6 rounded-xl hover:bg-slate-200 transition-all flex items-center justify-center gap-2 border border-slate-200">
            <Settings className="w-5 h-5" /> Setup/Add Course Format
          </button>
          <button onClick={() => onNavigate('generate')} className="bg-blue-600 text-white font-bold h-12 px-6 rounded-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-2 shadow-sm">
