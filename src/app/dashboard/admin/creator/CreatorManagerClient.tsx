...
import { BrainCircuit, Play, CheckCircle2, RotateCcw, AlertTriangle, Plus, Sparkles, BookOpen, Layers, Trash2, Edit2, Upload, X, Check } from 'lucide-react';
                ...
                <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div className="space-y-4 max-w-4xl">
                        {currentCourse.lmsNotesStructure.map((item, index) => (
                            <div key={item.id} className="flex flex-col md:flex-row gap-4 items-start md:items-center bg-slate-50 p-5 rounded-2xl border border-slate-100 group">
                                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-slate-200 text-slate-500 font-bold text-xs flex-shrink-0">
                                    {index + 1}
                                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden flex flex-col md:flex-row gap-6 h-[800px]">
                    ...
                    <div className="w-full md:w-[400px] flex-shrink-0 flex flex-col border border-slate-100 rounded-2xl bg-slate-50 overflow-hidden shadow-inner">
                        ...
                        <div className="p-5 space-y-4 flex-1 overflow-y-auto">
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Context: Subject</label>
                                <select
                            ...
                            <div className="mt-6">
                                <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 flex items-center justify-between">
                                    <span>Select Topics to Generate</span>
                                    {engineSection && engineSection.topics.length > 0 && (
                                        ...
                                        }} className="text-indigo-600 hover:text-indigo-800 lowercase tracking-normal">
                                        ...
                                        {!engineSection || engineSection.topics.length === 0 ? (
                                            ...
                                            engineSection.topics.map(t => (
                                                ...
                                                >
                                                    ...
                                                    {t.generatedNotes && <span title="Already Generated"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /></span>}
                                                </label>
                                            ))
                                        )}
                                    </div>
