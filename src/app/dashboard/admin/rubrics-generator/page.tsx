...
export default function RubricsGeneratorPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-10">
            {/* Header */}
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden print:hidden">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Rubrics Generator</h1>
                        </div>
                        <p className="text-slate-500 font-medium pl-13">
                            Automatically generate structured evaluation rubrics for any academic assessment.
                        </p>
                    </div>
                </div>
                <div className="absolute right-0 top-0 w-64 h-full bg-gradient-to-l from-emerald-50 to-transparent"></div>
            </div>
