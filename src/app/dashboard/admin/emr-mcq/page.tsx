    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 lg:space-y-8 flex flex-col pb-24 lg:pb-0 min-h-screen lg:h-[calc(100vh-8rem)] pt-4 lg:pt-0">
            <div className="text-center flex-shrink-0">
                <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 mb-2">EMR - MCQs Scanner</h2>
                <p className="text-sm lg:text-base text-slate-500 px-4">Fast OMR sheet evaluation using AI Vision against your established Answer Keys.</p>
            </div>
