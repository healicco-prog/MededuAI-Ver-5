    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 h-[calc(100vh-8rem)] flex flex-col">
            <div className="text-center mb-4 flex-shrink-0">
                <h2 className="text-3xl font-bold text-slate-900 mb-2">EMS - Essay Evaluation</h2>
                <p className="text-slate-500">Gemini-Powered automatic exam grading based on approved rubrics.</p>
            </div>
