...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign Up' link (element index 91) to open the signup page so the signup form can be tested.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/form/div[3]/p/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Input 'Test Student' into Full Name, input 'invalid-email' into Email Address, input 'ValidPass123!' into Password, then click 'Create Account' button to submit the form.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the 'Create Account' (Sign up) button to submit the form and trigger validation (click element index 199).
        frame = context.pages[-1]
        # Click element
